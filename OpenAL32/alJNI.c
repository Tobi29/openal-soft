...
#define GEN_JNI_FUN_HELPER(pkg, clazz, name) Java_##pkg##_##clazz##_##name
#define GEN_JNI_FUN(pkg, clazz, name) GEN_JNI_FUN_HELPER(pkg, clazz, name)
...
#define GEN_BIND0(pkg, clazz, name) \
GEN_JNI0(void, GEN_JNI_FUN(pkg, clazz, name)) { \
    name(); \
}
#define GEN_BIND0_R(pkg, clazz, name, rt, rc) \
GEN_JNI0(rt, GEN_JNI_FUN(pkg, clazz, name)) { \
    rc(r, r = name();); \
}
#define GEN_BIND1(pkg, clazz, name, p0, c0) \
GEN_JNI1(void, GEN_JNI_FUN(pkg, clazz, name), p0) { \
    c0(a0, v0, name(v0);); \
}
#define GEN_BIND1_R(pkg, clazz, name, rt, rc, p0, c0) \
GEN_JNI1(rt, GEN_JNI_FUN(pkg, clazz, name), p0) { \
    rc(r, c0(a0, v0, r = name(v0););); \
}
#define GEN_BIND2(pkg, clazz, name, p0, c0, p1, c1) \
GEN_JNI2(void, GEN_JNI_FUN(pkg, clazz, name), p0, p1) { \
    c0(a0, v0, c1(a1, v1, name(v0, v1);)); \
}
#define GEN_BIND2_R(pkg, clazz, name, rt, rc, p0, c0, p1, c1) \
GEN_JNI2(rt, GEN_JNI_FUN(pkg, clazz, name), p0, p1) { \
    rc(r, c0(a0, v0, c1(a1, v1, r = name(v0, v1);));); \
}
#define GEN_BIND3(pkg, clazz, name, p0, c0, p1, c1, p2, c2) \
GEN_JNI3(void, GEN_JNI_FUN(pkg, clazz, name), p0, p1, p2) { \
    c0(a0, v0, c1(a1, v1, c2(a2, v2, name(v0, v1, v2);))); \
}
#define GEN_BIND3_R(pkg, clazz, name, rt, rc, p0, c0, p1, c1, p2, c2) \
GEN_JNI3(rt, GEN_JNI_FUN(pkg, clazz, name), p0, p1, p2) { \
    rc(r, c0(a0, v0, c1(a1, v1, c2(a2, v2, r = name(v0, v1, v2);)));); \
}
#define GEN_BIND4(pkg, clazz, name, p0, c0, p1, c1, p2, c2, p3, c3) \
GEN_JNI4(void, GEN_JNI_FUN(pkg, clazz, name), p0, p1, p2, p3) { \
    c0(a0, v0, c1(a1, v1, c2(a2, v2, c2(a3, v3, name(v0, v1, v2, v3);)))); \
}
#define GEN_BIND4_R(pkg, clazz, name, rt, rc, p0, c0, p1, c1, p2, c2, p3, c3) \
GEN_JNI4(rt, GEN_JNI_FUN(pkg, clazz, name), p0, p1, p2, p3) { \
    rc(r, c0(a0, v0, c1(a1, v1, c2(a2, v2, c3(a3, v3, r = name(v0, v1, v2, v3);))));); \
}
#define GEN_BIND5(pkg, clazz, name, p0, c0, p1, c1, p2, c2, p3, c3, p4, c4) \
GEN_JNI5(void, GEN_JNI_FUN(pkg, clazz, name), p0, p1, p2, p3, p4) { \
    c0(a0, v0, c1(a1, v1, c2(a2, v2, c3(a3, v3, c4(a4, v4, name(v0, v1, v2, v3, v4);))))); \
}
#define GEN_BIND5_R(pkg, clazz, name, rt, rc, p0, c0, p1, c1, p2, c2, p3, c3, p4, c4) \
GEN_JNI5(rt, GEN_JNI_FUN(pkg, clazz, name), p0, p1, p2, p3, p4) { \
...
ALfloat* v = a ? (*env)->GetFloatArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseFloatArrayElements(env, a, v, 0);
#define GEN_CAST_ALDOUBLE_STAR(a, v, c) \
ALdouble* v = a ? (*env)->GetDoubleArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseDoubleArrayElements(env, a, v, 0);
#define GEN_CAST_ALINT_STAR(a, v, c) \
ALint* v = a ? (*env)->GetIntArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseIntArrayElements(env, a, v, 0);
#define GEN_CAST_ALUINT_STAR(a, v, c) \
ALint* v = a ? (*env)->GetIntArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseIntArrayElements(env, a, v, 0);
#define GEN_CAST_ALVOID_STAR(a, v, c) \
ALvoid* v = a ? (*env)->GetByteArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseByteArrayElements(env, a, v, 0);
#define GEN_CAST_ALBOOLEAN_STAR(a, v, c) \
ALboolean* v = a ? (*env)->GetBooleanArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseBooleanArrayElements(env, a, v, 0);
...
#define GEN_CAST_ALCCONTEXT_STAR(a, v, c) GEN_CAST(ALCcontext*, a, v, c)
#define GEN_CAST_ALCDEVICE_STAR(a, v, c) GEN_CAST(ALCdevice*, a, v, c)
#define GEN_CAST_ALCINT_STAR(a, v, c) \
ALCint* v = a ? (*env)->GetIntArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseIntArrayElements(env, a, v, 0);
#define GEN_CAST_ALCVOID_STAR(a, v, c) \
ALCvoid* v = a ? (*env)->GetByteArrayElements(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseByteArrayElements(env, a, v, 0);
#define GEN_CAST_ALCCHAR_STAR(a, v, c) \
ALCchar* v = a ? (*env)->GetStringUTFChars(env, a, NULL) : NULL; \
c; \
if (v) (*env)->ReleaseStringUTFChars(env, a, v);

#define GEN_RCAST_ALCENUM(r, c) GEN_RCAST(jint, ALCenum, r, c)
#define GEN_RCAST_ALCCONTEXT_STAR(r, c) GEN_RCAST(jlong, ALCcontext*, r, c)
#define GEN_RCAST_ALCDEVICE_STAR(r, c) GEN_RCAST(jlong, ALCdevice*, r, c)
...
#define GEN_PROPERTY_FUNS1(pkg, clazz, prefix, name, p0, c0) \
GEN_BIND2(pkg, clazz, prefix##name##f, p0, c0, jfloat, GEN_CAST_ALFLOAT) \
GEN_BIND4(pkg, clazz, prefix##name##3f, p0, c0, jfloat, GEN_CAST_ALFLOAT, jfloat, GEN_CAST_ALFLOAT, jfloat, GEN_CAST_ALFLOAT) \
GEN_BIND2(pkg, clazz, prefix##name##fv, p0, c0, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND2(pkg, clazz, prefix##name##i, p0, c0, jint, GEN_CAST_ALINT) \
GEN_BIND4(pkg, clazz, prefix##name##3i, p0, c0, jint, GEN_CAST_ALINT, jint, GEN_CAST_ALINT, jint, GEN_CAST_ALINT) \
GEN_BIND2(pkg, clazz, prefix##name##iv, p0, c0, jintArray, GEN_CAST_ALINT_STAR) \
GEN_BIND2(pkg, clazz, prefix##Get##name##f, p0, c0, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND4(pkg, clazz, prefix##Get##name##3f, p0, c0, jfloatArray, GEN_CAST_ALFLOAT_STAR, jfloatArray, GEN_CAST_ALFLOAT_STAR, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND2(pkg, clazz, prefix##Get##name##fv, p0, c0, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND2(pkg, clazz, prefix##Get##name##i, p0, c0, jintArray, GEN_CAST_ALINT_STAR) \
GEN_BIND4(pkg, clazz, prefix##Get##name##3i, p0, c0, jintArray, GEN_CAST_ALINT_STAR, jintArray, GEN_CAST_ALINT_STAR, jintArray, GEN_CAST_ALINT_STAR) \
GEN_BIND2(pkg, clazz, prefix##Get##name##iv, p0, c0, jintArray, GEN_CAST_ALINT_STAR)
#define GEN_PROPERTY_FUNS2(pkg, clazz, prefix, name, p0, c0, p1, c1) \
GEN_BIND3(pkg, clazz, prefix##name##f, p0, c0, p1, c1, jfloat, GEN_CAST_ALFLOAT) \
GEN_BIND5(pkg, clazz, prefix##name##3f, p0, c0, p1, c1, jfloat, GEN_CAST_ALFLOAT, jfloat, GEN_CAST_ALFLOAT, jfloat, GEN_CAST_ALFLOAT) \
GEN_BIND3(pkg, clazz, prefix##name##fv, p0, c0, p1, c1, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND3(pkg, clazz, prefix##name##i, p0, c0, p1, c1, jint, GEN_CAST_ALINT) \
GEN_BIND5(pkg, clazz, prefix##name##3i, p0, c0, p1, c1, jint, GEN_CAST_ALINT, jint, GEN_CAST_ALINT, jint, GEN_CAST_ALINT) \
GEN_BIND3(pkg, clazz, prefix##name##iv, p0, c0, p1, c1, jintArray, GEN_CAST_ALINT_STAR) \
GEN_BIND3(pkg, clazz, prefix##Get##name##f, p0, c0, p1, c1, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND5(pkg, clazz, prefix##Get##name##3f, p0, c0, p1, c1, jfloatArray, GEN_CAST_ALFLOAT_STAR, jfloatArray, GEN_CAST_ALFLOAT_STAR, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND3(pkg, clazz, prefix##Get##name##fv, p0, c0, p1, c1, jfloatArray, GEN_CAST_ALFLOAT_STAR) \
GEN_BIND3(pkg, clazz, prefix##Get##name##i, p0, c0, p1, c1, jintArray, GEN_CAST_ALINT_STAR) \
GEN_BIND5(pkg, clazz, prefix##Get##name##3i, p0, c0, p1, c1, jintArray, GEN_CAST_ALINT_STAR, jintArray, GEN_CAST_ALINT_STAR, jintArray, GEN_CAST_ALINT_STAR) \
GEN_BIND3(pkg, clazz, prefix##Get##name##iv, p0, c0, p1, c1, jintArray, GEN_CAST_ALINT_STAR)
